...
<body>
    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 2rem;">
        <h1 style="color: #1e40af; margin-bottom: 2rem;">Create New Author</h1>
        ...
        <form action="{{ route('authors.store') }}" method="POST" style="max-width: 500px;">
            ...
            <div>
                <button type="submit" style="padding:10px 20px; background:#10b981; color:white; border:none; border-radius:4px; cursor:pointer; font-weight: 500;">
                    Create Author
                </button>
